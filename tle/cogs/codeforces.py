...
_GITGUD_SCORE_DISTRIB = (2, 3, 5, 8, 12, 17, 23, 30, 38, 47, 57)
...
class Codeforces(commands.Cog):
    ...
    async def upsolve(self, ctx, choice: int = -1):
        ...
        points |   2  |   3  |   5  |  8  |  12  |  17  |  23  |  30  |  38  |  47  |  57
        """
    ...
    async def gitgud(self, ctx, *args):
        ...
        Point distribution:
        delta  | -300 | -200 | -100 |  0  | +100 | +200 | +300 | +400
        no tags|   2  |   3  |   5  |  8  |  12  |  17  |  23  |  30 
        tags   |   2  |   2  |   2  |  3  |   5  |   8  |  12  |  17
        """
        handle, = await cf_common.resolve_handles(ctx, self.converter, ('!' + str(ctx.author),))
        user = cf_common.user_db.fetch_cf_user(handle)
        rating = round(user.effective_rating, -2)
